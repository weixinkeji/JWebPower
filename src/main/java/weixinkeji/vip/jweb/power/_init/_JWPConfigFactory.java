...
//	 * @return RequestURLVO
//	 */
//	public JWPRequestUrlTool getRequestURLVO(String contextPath) {
//		return new JWPRequestUrlTool(contextPath, siConfig.getRequestUrlSuffix());
//	}
//
//	/**
//	 * 用户权限接口
...
//		JWPStaticResourcesURLExpresstion sre = findObject(JWPStaticResourcesURLExpresstion.class,
//				new DefaultJWPStaticResourcesURLExpresstion());
