 ...
 * <br>
 * 2。简化正则表达式写法。
 * <br>   **表示[点、斜杆、下划线、数字、大写小字母] （即会被替换成 [./a-zA-Z_-]）  
 * <br>   * 表达 26大小字母与0-9数字和下划线和一横杠（即会被替换成  [a-zA-Z_-]）  
 * 
 * <br>
 * 3。完整的正则表达式写法
 * <br>
...
public interface JWPControllerURLExpresstion {
	 ...
	 * 路径选择器的手段2：简单表达式  *号会自动被替换成[a-zA-Z0-9_-}{]， **号会自动被替换成[./a-zA-Z0-9_-}{]<br>
	 ...
	 * 路径选择器的手段2：简单表达式  [[会员等级]] (  *号会自动被替换成[a-zA-Z0-9_-}{]， **号会自动被替换成[./a-zA-Z0-9_-}{])<br>
	 ...
	 * 路径选择器的手段2：简单表达式 [[编号]]  *号会自动被替换成[a-zA-Z0-9_-}{]， **号会自动被替换成[./a-zA-Z0-9_-}{]<br>
